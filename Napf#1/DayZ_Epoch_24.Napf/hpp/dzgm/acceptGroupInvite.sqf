...
if (_groupExists) then {
    ...
    systemChat "[ADT-Team]Вы приняли приглашение";
	systemChat "[ADT-Team]Нажмите клавишу windows для переключения иконки игрока";
} else {
	systemChat "[ADT-Team]Группа больше не существует"; 
}; 