...
if (!isDedicated) then {
	...
	player_zombieAttack = 			compile preprocessFileLineNumbers "custom\player_zombieAttack.sqf";	//Fix_ "by GROM" Scripts_ ADT-MOD
	fnc_usec_damageActions =		compile preprocessFileLineNumbers "scripts\medical\fn_damageActions.sqf";		//Checks which actions for nearby casualty
	fnc_inAngleSector =				compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_inAngleSector.sqf";		//Checks which actions for nearby casualty
	fnc_usec_selfActions =			compile preprocessFileLineNumbers "custom\fn_selfActions.sqf";		//fix_adt
	...
	player_unlockVault =            compile preprocessFileLineNumbers "custom\player_unlockVault.sqf"; //SnapPro
	...
	player_lockVault =          compile preprocessFileLineNumbers "custom\player_lockVault.sqf"; //SnapPro
	...
	player_switchModel =        compile preprocessFileLineNumbers "custom\player_switchModel.sqf";	//Vector Building
	...
	player_drink =				compile preprocessFileLineNumbers "scripts\medical\player_drink.sqf";
	player_eat =				compile preprocessFileLineNumbers "scripts\medical\player_eat.sqf";
	//player_useMeds =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_useMeds.sqf"; //dayz epoch
	player_useMeds =			compile preprocessFileLineNumbers "scripts\medical\player_useMeds.sqf"; //adt-team
	...
	fnc_usec_damageHandler =		compile preprocessFileLineNumbers "custom\fn_damageHandler.sqf";		//fix_ by GROM & ADT-MOD
	...
	local_lockUnlock =          compile preprocessFileLineNumbers "custom\local_lockUnlock.sqf"; // Vehicles Remote Lock
	...
	//player_humanityChange =			compile preprocessFileLineNumbers "custom\player_humanityChange.sqf";
...
fnc_usec_damageVehicle =        compile preprocessFileLineNumbers "scripts\vehicles\fn_damageHandlerVehicle.sqf";     
vehicle_handleDamage =          compile preprocessFileLineNumbers "scripts\vehicles\vehicle_handleDamage.sqf";		

initialized = true;

//snap_pro v.1.2.1 by GROM 29.07.2014
