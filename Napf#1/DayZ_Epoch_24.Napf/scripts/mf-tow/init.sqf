...
MF_Tow_Towable_Array =
{
	...
	switch (typeOf _towTruck) do
	{
		...
		case "policecar":			{_array = ["Motorcycle","Car"];};
		...
		case "UralCivil2_DZE": 						{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "UralCivil_DZE": 						{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "MTVR": 						{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "MTVR_DES_EP1": 						{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "GAZ_Vodnik_DZE": 						{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "GAZ_Vodnik_MedEvac": 						{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "Kamaz": 						{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "KamazOpen_DZE": 						{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "TowingTractor": 					{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Air"];};
		case "BMP3": 					{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Air"];};
		case "BTR60_TK_EP1": 					{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "BTR90": 						{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Air"];};
		case "BRDM2_CDF": 					{_array = ["Motorcycle","Car"];};
		case "AAV": 					{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Air"];};
		case "M113_UN_EP1": 					{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Air"];};
		case "M113_TK_EP1": 					{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Air"];};
		case "M113Ambul_UN_EP1": 					{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "LAV25": 					{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "TowingTractor": 					{_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Air"];};
	};
...
if(_towableVehiclesTotal > 0) then {
	if (s_player_towing < 0) then {
		if(!(_cursorTarget getVariable ["MFTowIsTowing", false])) then {
			s_player_towing = player addAction [("<t color=""#AEA719"">" + ("Буксировать") +"</t>"), format["%1\tow_AttachTow.sqf", MF_Tow_Base_Path], _cursorTarget, 0, false, true, "",""];				
		} else {
			s_player_towing = player addAction [("<t color=""#AEA719"">" + ("Отцепить") +"</t>"), format["%1\tow_DetachTow.sqf", MF_Tow_Base_Path], _cursorTarget, 0, false, true, "",""];			
		};
	};
} 
else {
